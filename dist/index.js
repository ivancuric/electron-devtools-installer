...
var getIDMapPath = function getIDMapPath() {
  return _path2.default.resolve((0, _utils.getPath)(), 'IDMap.json');
};
if (_fs2.default.existsSync(getIDMapPath())) {
  try {
    IDMap = JSON.parse(_fs2.default.readFileSync(getIDMapPath(), 'utf8'));
  } catch (err) {
...
var install = function install(extensionReference) {
  ...
  return (0, _downloadChromeExtension2.default)(chromeStoreID, forceDownload).then(function (extensionFolder) {
    ...
    _fs2.default.writeFileSync(getIDMapPath(), JSON.stringify(Object.assign(IDMap, _defineProperty({}, chromeStoreID, name))));
